...
public class SeedDataInitializer implements ApplicationRunner {
  ...
  private void seedUsers() {
    seedUser(
        "user_admin", "admin", "Admin@123", "系统管理员", UserRole.ADMIN, "13800000001", "负责平台运维与权限管理");
    seedUser(
        "user_dispatcher",
        "dispatcher",
        "Disp@123",
  ...
  private void seedBusinessData() {
    ...
    if (dataStore.list(DataCategory.AREA).isEmpty()) {
      area(
          ...
          "主变区域",
          List.of(
              latLng(30.2745, 120.1545),
              latLng(30.2745, 120.1558),
              latLng(30.2738, 120.1558),
              latLng(30.2738, 120.1545)));
      area(
          "area_002",
          "site_001",
          "GIS 设备区",
          List.of(
              latLng(30.2737, 120.1546),
              latLng(30.2737, 120.1556),
              latLng(30.2732, 120.1556),
              latLng(30.2732, 120.1546)));
      area(
          "area_003",
          "site_002",
          "开关室",
          List.of(
              latLng(30.2602, 120.1195),
              latLng(30.2602, 120.1205),
              latLng(30.2596, 120.1205),
              latLng(30.2596, 120.1195)));
    }
    ensureSingleRobot();
    if (dataStore.list(DataCategory.DETECTION_TEMPLATE).isEmpty()) {
      template(
          ...
          "路线标准检测",
          "ROUTE",
          List.of("PERSON", "HELMET", "OBSTACLE", "FIRE"),
          "行进过程中持续检测人员、安全帽、障碍物与火源",
          map(),
      ...
      template(
          ...
          "刀闸开关检测",
          "CHECKPOINT",
          List.of("SWITCH", "METER"),
          "检查点刀闸分合状态与表计读数",
          map("SWITCH", "变电设备上的刀闸开关操作手柄、连杆及触头区域", "METER", "圆形机械压力表的完整表盘和指针区域"),
          "2026-01-10T08:00:00Z");
      template(
          "tpl_cp_002",
          "设备渗漏检测",
          "CHECKPOINT",
          List.of("OIL_LEAK", "FOREIGN_OBJECT", "FIRE"),
          "变压器及 GIS 渗漏、异物与烟火",
          map(
              "OIL_LEAK",
  ...
  /**
   * Adds a complete, non-destructive demonstration scenario. Every record has a stable id and is
   * inserted only when absent, so restarting the service neither duplicates nor overwrites
  ...
  private void seedDemoAreas() {
    insertIfMissing(
        ...
        map(
            ...
            "polygon",
            List.of(
                latLng(30.2595, 120.1194),
                latLng(30.2595, 120.1200),
                latLng(30.2590, 120.1200),
                latLng(30.2590, 120.1194)),
            "createdAt",
            daysAgo(20)));
    insertIfMissing(
        DataCategory.AREA,
        map(
            ...
            "polygon",
            List.of(
                latLng(30.1854, 120.2644),
                latLng(30.1854, 120.2656),
                latLng(30.1846, 120.2656),
                latLng(30.1846, 120.2644)),
            "createdAt",
            daysAgo(18)));
    insertIfMissing(
        DataCategory.AREA,
        map(
            ...
            "polygon",
            List.of(
                latLng(30.1845, 120.2645),
                latLng(30.1845, 120.2655),
                latLng(30.1839, 120.2655),
                latLng(30.1839, 120.2645)),
            "createdAt",
            daysAgo(18)));
  }
  ...
  private void seedDemoRobots() {
    ...
    insertIfMissing(
        ...
        demoRobot(
            ...
            "ONLINE",
            93,
            latLng(30.1849, 120.2649),
            null));
  }

  private Map<String, Object> demoRobot(
      String id,
      String name,
      String model,
      String serialNo,
    ...
    Map<String, Object> item =
        map(
            ...
            "v3.2.0",
            "lastOnlineAt",
            minutesAgo(status.equals("OFFLINE") ? 180 : 2),
            "createdAt",
            daysAgo(30));
  ...
  private void seedDemoRoutes() {
    ...
    List<Map<String, Object>> switchyardPath =
        List.of(
            ...
            latLng(30.2601, 120.1201),
            latLng(30.2598, 120.1204),
            latLng(30.2594, 120.1202));
    insertIfMissing(
        DataCategory.ROUTE,
        demoRoute(
            "route_demo_002",
    ...
    List<Map<String, Object>> outdoorPath =
        List.of(
            latLng(30.1850, 120.2650),
            latLng(30.1853, 120.2654),
            latLng(30.1848, 120.2657),
            latLng(30.1843, 120.2652));
    insertIfMissing(
        DataCategory.ROUTE,
        demoRoute(
            "route_demo_003",
  ...
  private Map<String, Object> demoRoute(
      String id,
      String siteId,
      String name,
      String description,
    ...
    return map(
        ...
        "2d",
        "routeDetections",
        detectionItems("PERSON", "HELMET", "OBSTACLE", "FIRE"),
        "checkpoints",
        checkpoints,
        "createdAt",
        createdAt);
  ...
  private Map<String, Object> demoCheckpoint(
      String id,
      String routeId,
      String name,
      int seq,
  ...
  private void seedDemoTasksAndEvents() {
    ...
    insertIfMissing(
        ...
        map(
            ...
            "note",
            "受雷雨天气影响取消，已改期"));
    // Historical completed tasks referenced by demo records/alarms (satisfy FK integrity when
    // present).
    insertIfMissing(
        DataCategory.TASK,
        map(
    ...
    event(
        ...
        "已完成开关柜状态与仪表读数识别",
        "10kV 开关柜 A 段",
        "https://picsum.photos/seed/demo-switchgear/400/240",
        minutesAgo(33));
    event(
        "evt_demo_004",
        "task_demo_active",
    ...
    event(
        ...
        "检测到现场作业人员，任务转人工接管",
        "母线桥接区",
        "https://picsum.photos/seed/demo-helmet/400/240",
        minutesAgo(22));
    event(
        "evt_demo_006",
        "task_demo_paused",
  ...
  private void event(
      ...
      String createdAt) {
    Map<String, Object> item =
        map("id", id, "taskId", taskId, "type", type, "message", message, "createdAt", createdAt);
  ...
  private void seedDemoAlarms() {
    ...
    currentDemoAlarm(
        ...
        "FIRE",
        "CRITICAL",
        "红外画面出现疑似局部过热热点，需立即复核",
        "https://picsum.photos/seed/demo-hotspot/400/240",
        false,
        minutesAgo(16));
    currentDemoAlarm(
        "alarm_demo_003",
        ...
        "HIGH",
        "主变底部疑似存在渗油痕迹",
        "https://picsum.photos/seed/demo-oil-leak/400/240",
        false,
        hoursAgo(5));
    currentDemoAlarm(
        "alarm_demo_004",
        ...
        "METER",
        "LOW",
        "压力表读数处于预警区间，建议下次巡检复核",
        "https://picsum.photos/seed/demo-meter/400/240",
        true,
        daysAgo(1));
    currentDemoAlarm(
        "alarm_demo_policy_critical",
        "task_demo_paused",
        "城南 500kV 户外设备巡检",
        "1# 主变 A 相",
        "FIRE",
        "CRITICAL",
        "【测试】CRITICAL 告警，应自动创建 URGENT 工单",
        "https://picsum.photos/seed/policy-critical/400/240",
        false,
        minutesAgo(1));
    currentDemoAlarm(
        "alarm_demo_policy_high",
        "task_demo_active",
        "城西开关室日常巡检",
        "母线桥接区",
        "HELMET",
        "HIGH",
        "【测试】HIGH 告警，等待人工转工单",
        "https://picsum.photos/seed/policy-high/400/240",
        false,
        minutesAgo(2));
    currentDemoAlarm(
        "alarm_demo_policy_low",
        "task_demo_cancelled",
        "城西开关室日常巡检",
        "2# 电容器组",
        "METER",
        "LOW",
        "【测试】LOW 告警，等待人工转工单",
        "https://picsum.photos/seed/policy-low/400/240",
        false,
        minutesAgo(3));
    historicalDemoAlarm(
        "alarm_demo_005",
        ...
        "HIGH",
        "GIS 刀闸状态与计划状态不一致",
        "https://picsum.photos/seed/demo-switch/400/240",
        true,
        daysAgo(2));
    historicalDemoAlarm(
        "alarm_demo_006",
        ...
        "MEDIUM",
        "机器人前方发现临时施工围栏，已减速绕行",
        "https://picsum.photos/seed/demo-obstacle/400/240",
        true,
        daysAgo(3));
    historicalDemoAlarm(
        "alarm_demo_007",
        ...
        "MEDIUM",
        "发现绝缘子附近悬挂异物",
        "https://picsum.photos/seed/demo-foreign-object/400/240",
        false,
        daysAgo(4));
    historicalDemoAlarm(
        "alarm_demo_008",
        ...
        "MEDIUM",
        "检测到未授权人员进入设备区",
        "https://picsum.photos/seed/demo-person/400/240",
        true,
        daysAgo(5));
    historicalDemoAlarm(
        "alarm_demo_009",
        ...
        "LOW",
        "避雷器泄漏电流读数轻微波动",
        "https://picsum.photos/seed/demo-arrester/400/240",
        true,
        daysAgo(6));
    historicalDemoAlarm(
        "alarm_demo_policy_history_pending",
        "task_hist_demo_008",
        "城东主变区例行巡检",
        "GIS 刀闸",
        "SWITCH",
        "MEDIUM",
        "【测试】历史告警，无关联工单",
        "https://picsum.photos/seed/policy-history-pending/400/240",
        true,
        daysAgo(7));
    historicalDemoAlarm(
        "alarm_demo_policy_history",
        "task_hist_demo_008",
        "城东主变区例行巡检",
        "GIS 刀闸",
        "SWITCH",
  ...
  private void historicalDemoAlarm(
      String id,
      String taskId,
      String routeName,
      String checkpointName,
  ...
  private Map<String, Object> demoAlarmItem(
      String id,
      String taskId,
      String routeName,
      String checkpointName,
  ...
  private void seedDemoWorkOrders() {
    ...
    insertWorkOrderIfAlarmFree(
        map(
            ...
            "立即安排现场人员复核红外热点及温升数据。",
            "locationDescription",
            "城南 500kV 变电站 / 户外主变区 / 1# 主变 A 相 / 接线区域",
            "source",
            "AUTO",
            "status",
            "PROCESSING",
    ...
    insertWorkOrderIfAlarmFree(
        map(
            ...
            "检查主变底部油位、密封件与地面油迹。",
            "locationDescription",
            "城南 500kV 变电站 / 户外主变区 / 1# 主变 A 相 / 本体底部",
            "source",
            "MANUAL",
            "status",
            "REVIEW",
            ...
            "张调度",
            "resolution",
            "现场未发现持续渗漏，已清洁油迹并安排 24 小时复测。",
            "review",
            map(
                "conclusion",
                "PARTIALLY_RESOLVED",
                "onsiteFinding",
                "复核主变本体底部、油位计和密封件，未发现持续渗漏。",
                "handlingMeasures",
                "已清洁历史油迹并完成油位复测，当前读数正常。",
                "followUpPlan",
                "安排 24 小时后复测油位与地面油迹。",
                "submittedById",
                "user_dispatcher",
    ...
    insertWorkOrderIfAlarmFree(
        map(
            "id",
            "wo_demo_policy_history",
            "alarmId",
            "alarm_demo_policy_history",
            "title",
            "历史告警工单",
            "description",
            "【测试】用于验证缺少转单来源时的“已有工单”展示。",
            "source",
            "MANUAL",
            "status",
            "CLOSED",
    ...
    if (alarmId != null) {
      boolean alarmTaken =
          dataStore.list(DataCategory.WORK_ORDER).stream()
              .anyMatch(
                  order -> String.valueOf(alarmId).equals(String.valueOf(order.get("alarmId"))));
      if (alarmTaken) {
        return;
      }
    }
  ...
  private void seedDemoNotifications() {
    ...
    demoNotification(
        ...
        "WORKORDER",
        "紧急工单已自动创建",
        "工单 wo_alarm_alarm_demo_002 已由系统自动创建，待调度员处理。",
        "/workorders",
        false,
        minutesAgo(12));
    demoNotification(
    ...
    insertIfMissing(
        ...
        map(
            ...
            map(
                ...
                "CRITICAL",
                "cause",
                "红外画面显示主变 A 相接线区域温度异常升高，存在局部过热风险。",
                "recommendedActions",
                List.of("立即安排现场红外复测", "核查负荷电流与接线端子紧固状态", "复测前保持该区域重点监视"),
                "citations",
                List.of("告警截图", "巡检任务上下文", "红外复核结果"),
                "confidence",
                0.91)));
    insertIfMissing(
        ...
        map(
            ...
            "告警证据",
            "content",
            "主变 A 相出现疑似局部过热热点，告警等级为 CRITICAL。",
            "imageUrl",
            "https://picsum.photos/seed/demo-hotspot/400/240",
            "payload",
            map("alarmId", "alarm_demo_002"),
            "createdAt",
            hoursAgo(3)));
    insertIfMissing(
        DataCategory.AGENT_EVIDENCE,
        map(
            ...
            "任务上下文",
            "content",
            "任务已在 1# 主变 A 相检查点暂停，等待现场值班员确认。",
            "payload",
            map("taskId", "task_demo_paused"),
            "createdAt",
            hoursAgo(3)));
    insertIfMissing(
        DataCategory.AGENT_EVIDENCE,
  ...
  private Map<String, Object> agentStep(
      String id, String runId, String sessionId, String type, String message, String createdAt) {
    return map(
        "id",
        id,
        "runId",
  ...
  private void ensureSingleRobot() {
    ...
    // Simulation keeps seed ONLINE for dispatch demos/tests; bridge starts OFFLINE until heartbeat.
    String status = robotProperties.isBridgeMode() ? "OFFLINE" : "ONLINE";
    robot(
        robotId,
        "电力巡检机器人",
        "Jetson Orin + ZLAC8015D",
        "YLHB-001",
        "site_001",
        status,
        null,
  ...
  private void template(
      ...
      String createdAt) {
    dataStore.upsert(
        DataCategory.DETECTION_TEMPLATE,
        map(
            "id",
            id,
            "name",
    ...
    List<Map<String, Object>> cps =
        List.of(
            map(
                ...
                25,
                "detections",
                detectionItems("SWITCH", "METER", "OIL_LEAK", "FIRE", "FOREIGN_OBJECT")),
            map(
                "id",
                "cp_demo_002",
                "routeId",
    ...
    return map(
        ...
        "start_pose",
            map(
                ...
                "Initial pose",
                "pose",
                map("x", 0.5, "y", -0.5, "yaw", 0.2),
                "publish_initial_pose",
                true,
                "covariance",
                map("x", 0.25, "y", 0.25, "yaw", 0.0685)),
        "targets",
            List.of(
                map(
                    "id",
        ...
        "routes",
            List.of(
                map(
                    ...
                    "Main patrol route",
                    "target_ids",
                    List.of("target_001", "target_002", "target_003"),
                    "return_to_start",
                    true,
                    "loop",
                    map("enabled", false, "wait_sec", 600, "max_cycles", 0),
                    "goal_timeout_sec",
                    120,
                    "max_retries_per_checkpoint",
                    1,
                    "failure_policy",
  ...
  private void notification(
      String id, String userId, String type, String title, String content, String link) {
    dataStore.upsert(
        DataCategory.NOTIFICATION,
        map(
            "id",
