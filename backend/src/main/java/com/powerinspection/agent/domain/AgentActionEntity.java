...
public class AgentActionEntity {
  ...
  @Enumerated(EnumType.STRING) @Column(nullable = false) private AgentEnums.ActionType type;
  ...
  @Column(name = "rejected_by_id") private String rejectedById;
  @Column(name = "rejected_at") private Instant rejectedAt;
  @Column(name = "rejection_comment") private String rejectionComment;
  @Column(name = "execution_started_at") private Instant executionStartedAt;
  @Column(name = "execution_completed_at") private Instant executionCompletedAt;
  ...
  public AgentEnums.ActionType getType() { return type; } public void setType(AgentEnums.ActionType value) { type = value; }
  ...
  public String getRejectedById() { return rejectedById; } public void setRejectedById(String value) { rejectedById = value; }
  public Instant getRejectedAt() { return rejectedAt; } public void setRejectedAt(Instant value) { rejectedAt = value; }
  public String getRejectionComment() { return rejectionComment; } public void setRejectionComment(String value) { rejectionComment = value; }
  public Instant getExecutionStartedAt() { return executionStartedAt; } public void setExecutionStartedAt(Instant value) { executionStartedAt = value; }
  public Instant getExecutionCompletedAt() { return executionCompletedAt; } public void setExecutionCompletedAt(Instant value) { executionCompletedAt = value; }
