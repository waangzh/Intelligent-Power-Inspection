...
public class AgentController {
  ...
  public AgentController(AgentService agentService, PermissionService permissionService, CurrentUser currentUser) {
  ...
  public ApiResponse<Map<String, Object>> createSession(@RequestBody Map<String, Object> body) {
    ...
    return ApiResponse.ok(agentService.createSession(body, currentUser.get()));
  }

  @GetMapping("/sessions")
  public ApiResponse<List<Map<String, Object>>> sessions() {
    permissionService.require(currentUser.get(), Permission.TASK_DISPATCH);
    return ApiResponse.ok(agentService.sessions());
  }
