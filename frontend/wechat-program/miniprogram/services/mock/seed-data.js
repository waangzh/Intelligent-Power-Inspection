...
const seedWorkOrders = [
  ...
  { id: 'wo_seed_2', title: 'GIS 区未佩戴安全帽', description: '路线行进中检测到作业人员未佩戴安全帽', status: 'PENDING', priority: 'URGENT', createdById: 'user_dispatcher', createdByName: '张调度', location: { siteName: '城东 220kV 变电站', routeName: '主变区例行巡检', areaName: '主变区例行巡检', address: '浙江省杭州市余杭区' }, createdAt: '2026-06-12T14:30:00Z', updatedAt: '2026-06-12T14:30:00Z' },
]
