...
const openapiClient = {
  ...
  robots: {
    ...
    track(robotId, query) { return get(buildPath(API_PATHS.robotsRobotIdTrack, { robotId }), query) },
    listLocations(query) { return get(buildPath(API_PATHS.robotsLocations), query) },
